...
class V {
  ...
  // DM Sans — closer to Claude's Söhne aesthetic; Inter is the fallback
...
ThemeData buildTheme() => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    hintStyle: V.sans(color: V.textMute, size: 15),
  ...
  appBarTheme: AppBarTheme(
    ...
    elevation: 0,
    titleTextStyle: V.sans(size: 15, weight: FontWeight.w600),
